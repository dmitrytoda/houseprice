...
```{r}
las_xgb_submit <- data.frame('Id'=test_Ids, 'SalePrice'=rowMeans(cbind(lasso_pred,xgb_pred)))
write.csv(las_xgb_submit, 'lasso_xgb.csv', row.names = FALSE)
```

LB score of 0.12185, better than both Lasso and XGB by themselves.